...
function Apply({ history, role }) {
  ...
  const submitHandler = (e) => {
    ...
    // adjustedFromTime.setHours(
    //   adjustedFromTime.getHours() + 5,
    //   adjustedFromTime.getMinutes() + 30
    // );

    const adjustedToTime = new Date(totime);
    // adjustedToTime.setHours(
    //   adjustedToTime.getHours() + 5,
    //   adjustedToTime.getMinutes() + 30
    // );
  ...
  return (
    // <MainScreen className="apply" title="Apply for outpass">
    <>
